...
class EpubCFI {
  ...
  parse(cfiStr) {
    ...
    let baseComponent; let pathComponent; let range;
  ...
  parseStep(stepStr){
    let type; let num; let index; let has_brackets; let id;
  ...
  parseTerminal(termialStr){
    let characterOffset; let textLocationAssertion;
  ...
  compare(cfiOne, cfiTwo) {
    let stepsA; let stepsB;
    let terminalA; let terminalB;

    let rangeAStartSteps; let rangeAEndSteps;
    var rangeBEndSteps; var rangeBEndSteps;
    let rangeAStartTerminal; let rangeAEndTerminal;
    let rangeBStartTerminal; let rangeBEndTerminal;
  ...
  filter(anchor, ignoreClass) {
    ...
    let parent; let previousSibling; let nextSibling;
    let isText = false;
  ...
  normalizedMap(children, nodeType, ignoreClass) {
    const output = {};
    let prevIndex = -1;
    let i; const len = children.length;
    let currNodeType;
    let prevNodeType;
  ...
  filteredPosition(anchor, ignoreClass) {
    let children; let index; let map;
  ...
  toRange(_doc, ignoreClass) {
    const doc = _doc || document;
    let range;
    let start; let end; let startContainer; let endContainer;
    const cfi = this;
    let startSteps; let endSteps;
